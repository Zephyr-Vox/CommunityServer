...
func (a *App) routes(e *echo.Echo) error {
	...
	api.GET("/groups/:id/access", channel.ListGroupAccessHandler(a.channels), authed()...)
	api.POST("/groups/:id/access", channel.AddGroupAccessHandler(a.channels), authed()...)
	api.DELETE("/groups/:id/access/:access_id", channel.DeleteGroupAccessHandler(a.channels), authed()...)
	api.GET("/groups/:id", channel.GetGroupHandler(a.channels), authed()...)
	api.PATCH("/groups/:id", channel.UpdateGroupHandler(a.channels), authed()...)
